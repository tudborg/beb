...
LIB0_LOG_COLOR_DATE='\033[1;90m'
LIB0_LOG_COLOR_DEBUG='\033[1;36m'
LIB0_LOG_COLOR_INFO='\033[0;34m'
...
lib0-log-msg () {
    ...
    if [ "$LEVELNUM" -ge "${LIB0_LOG_LEVEL:-$LIB0_DEFAULT_LOG_LEVEL_NUM}" ]; then
        local MESSAGE="$2"
        local TIME="${LIB0_LOG_COLOR_DATE}$(date +"%Y-%m-%d %H:%M:%S")${LIB0_LOG_COLOR_NONE}"
